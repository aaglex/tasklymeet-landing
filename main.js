...
const stepsData = [
    {
        ...
        description: "Connect TasklyMeet to your calendar or join via Zoom, Google Meet, or Microsoft Teams.",
        icon: "fas fa-plug",
    },
    {
        number: "02",
...
const contactData = [
    { label: "hello@tasklymeet.com", icon: "fas fa-envelope", href: "mailto:hello@tasklymeet.com" },
    { label: "San Francisco, CA",    icon: "fas fa-map-marker-alt", href: "#" },
];
    ...
    const slides = [
        `<div class="mockup-slide">
            <div class="mock-bar">
                ...
                <div class="mock-url">Summary — TasklyMeet</div>
            </div>
        ...
        `<div class="mockup-slide">
            <div class="mock-bar">
                <div class="mock-dots"><span class="r"></span><span class="y"></span><span class="g"></span></div>
                <div class="mock-url">Integrations — TasklyMeet</div>
            </div>
            <div class="slide-inner">
                ...
                <div class="int-grid">
                    ${[
                        ...
                        { name:'Meet',   bg:'#34A853', icon:'fas fa-video', ok:true },
        ...
        `<div class="mockup-slide">
            <div class="mock-bar">
                <div class="mock-dots"><span class="r"></span><span class="y"></span><span class="g"></span></div>
                <div class="mock-url">Team View — TasklyMeet</div>
            </div>
            <div class="slide-inner">
